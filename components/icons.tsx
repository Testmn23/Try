...
export const MagicWandIcon = (props: React.SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path d="M15 16v-2" />
    <path d="M15 10V8" />
    <path d="M12.3 21.7 7 16.4l-4 4L9.6 24" />
    <path d="m21.7 12.3-5.3-5.3-4 4L16.4 17l5.3-5.3z" />
    <path d="M9 4V2" />
    <path d="M9 22v-2" />
    <path d="M9 16v-2" />
    <path d="m4 15-2-2" />
...
export const BeachIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg
      ...
      strokeLinejoin="round"
    >
        <path d="M18 22a2 2 0 0 0 2-2V7l-4-2-4 2-4-2-4 2v13a2 2 0 0 0 2 2Z" />
        <path d="M16 2.5 19 4" />
        <path d="m8 2.5 3 1.5" />
        <path d="M12.5 4.5 16 6" />
        <path d="M5 7.5 8 9" />
        <path d="m19 12-3-1.5" />
        <path d="m5 14.5 3 1.5" />
        <path d="m19 18-3-1.5" />
    </svg>
);

export const CafeIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg
      {...props}
      xmlns="http://www.w3.org/2000/svg"
      width="24"
      ...
      strokeLinejoin="round"
    >
        <path d="M17 8h-7a4 4 0 0 0-4 4v2a4 4 0 0 0 4 4h7a4 4 0 0 0 4-4v-2a4 4 0 0 0-4-4Z" />
...
export const RectangleVerticalIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg
      {...props}
      xmlns="http://www.w3.org/2000/svg"
      width="24"
