            ...
            >
                ...
                >
                    <div className="flex items-center justify-between p-4 border-b border-stone-200 dark:border-stone-800">
                        <h2 className="text-2xl font-serif tracking-wider text-gray-800 dark:text-stone-200">Add Garment</h2>
                        <button onClick={onClose} className="p-1 rounded-full text-gray-500 hover:bg-gray-100 dark:hover:bg-stone-800 hover:text-gray-800 dark:hover:text-stone-200">
